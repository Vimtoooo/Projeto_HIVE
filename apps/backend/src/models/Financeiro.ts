...
export class Financeiro {
  ...
  public static registrarReceita(
    ...
    console.log(
      `Receita de R$${valor} registrada para a contratação ${contratacao.getIdContratacao}.`,
    );
  ...
  public static registrarDespesa(
    ...
    console.log(
      `Despesa de R$${valor} registrada para a contratação ${contratacao.getIdContratacao}.`,
    );
    return new Financeiro(
      contratacao,
  ...
  // Getters e Setters
  public get getIdFinanceiro(): number {
    return this.idFinanceiro;
  }

  public get getFatura(): Fatura | undefined {
    return this.fatura;
  }
  public set setFatura(fatura: Fatura | undefined) {
    this.fatura = fatura;
  }
  ...
  public get getTipoRegistro(): TipoRegistro {
    return this.tipoRegistro;
  }
  public set setTipoRegistro(tipo: TipoRegistro) {
  ...
  public set setValor(valor: number) {
    if (valor <= 0)
      throw new Error('O valor do registro financeiro deve ser positivo.');
    this.valor = valor;
  }

  public get getDescricao(): string | undefined {
  ...
  public get getDataRegistro(): Date {
