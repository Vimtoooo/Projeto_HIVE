...
export class Contratacao {
  ...
  // Getters e Setters
  public get getIdContratacao(): number {
    return this.idContratacao;
  }
  public get getDataContratacao(): Date {
  ...
  public get getContratante(): Usuario {
    return this.contratante;
  }
  public set setContratante(contratante: Usuario) {
    this.contratante = contratante;
  }

  public get getIndicacao(): Indicacao | undefined {
    return this.indicacao;
  }
  public set setIndicacao(indicacao: Indicacao) {
    this.indicacao = indicacao;
  }

  public get getStatus(): StatusContratacao {
    return this.status;
  }
  public set setStatus(status: StatusContratacao) {
    this.status = status;
  }
  ...
  public set setValor(valor: number) {
    if (valor <= 0)
      throw new Error('O valor da contratação deve ser positivo.');
    this.valor = valor;
  }

  public get getFormaPagamento(): FormaPagamento {
    return this.formaPagamento;
  }
  public set setFormaPagamento(forma: FormaPagamento) {
    this.formaPagamento = forma;
  }

  public get getDataVencimento(): Date | undefined {
